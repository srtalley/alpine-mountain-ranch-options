...
<p><?php esc_html_e( 'The following reservation has been cancelled by the customer. The details of the cancelled reservation can be found below.', 'woocommerce-appointments' ); ?></p>
