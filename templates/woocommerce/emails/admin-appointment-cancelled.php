...
<p><?php esc_html_e( 'The following appointment has been cancelled by the customer. The details of the cancelled appointment can be found below.', 'woocommerce-appointments' ); ?></p>
